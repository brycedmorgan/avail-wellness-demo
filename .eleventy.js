module.exports = function(eleventyConfig) {
  ...
  // Inline SVG icon shortcode (Lucide-style, stroke-based, 24x24).
  // Usage: {% icon "calendar", "icon-class-name" %}
  const ICON_PATHS = {
    ...
    "flask":        '<path d="M9 2h6M10 2v6.6L4.5 18.4A2 2 0 0 0 6.2 21h11.6a2 2 0 0 0 1.7-2.6L14 8.6V2"/>',
    ...
    "brain":        '<path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 0 0 12 21.978V5z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 0 1 12 21.978V5z"/>',
  ...
  eleventyConfig.addShortcode("icon", function(name, className = "", size = 18) {
    const path = ICON_PATHS[name];
    if (!path) return `<!-- icon: ${name} not found -->`;
    const cls = className ? ` class="${className}"` : ' class="icon"';
    return `<svg${cls} width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${path}</svg>`;
  });
